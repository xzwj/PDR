...
//	private ExtendSmoothingSchema smoothingSchema;
	 ...
	 * @param observer
	 */
	public YStepCounter(Observer observer){
		StepStateSwitcher switcher=new YStepStateSwitcher();
